...
# MNLI
JIANT_OVERRIDES="train_tasks = none, allow_untrained_encoder_parameters = 1, eval_data_fraction = 0.00255, do_train = 0, eval_tasks = mnli, do_eval = 1, run_name = lc-target-mnli-1k-elmo, elmo_chars_only = 0, sep_embs_for_skip = 1" JIANT_CONF="config/final.conf" sbatch nyu_cilvr_cluster.sbatch
...
# QQP
JIANT_OVERRIDES="train_tasks = none, allow_untrained_encoder_parameters = 1, eval_data_fraction = 0.00275, do_train = 0, eval_tasks = qqp, do_eval = 1, run_name = lc-target-qqp-1k-elmo, elmo_chars_only = 0, sep_embs_for_skip = 1" JIANT_CONF="config/final.conf" sbatch nyu_cilvr_cluster.sbatch
...
## Pretraining learning curves for Reddit
...
JIANT_OVERRIDES="train_tasks = reddit_s2s_3.4G, training_data_fraction = 0.01430, run_name = reddit_s2s-256k-elmo, elmo_chars_only = 0, sep_embs_for_skip = 1, lr = 0.001, max_grad_norm = 1.0, mt_attention = bilinear, max_seq_len = 64, batch_size = 24" JIANT_CONF="config/final.conf" sbatch nyu_cilvr_cluster.sbatch
...
JIANT_OVERRIDES="train_tasks = reddit_s2s_3.4G, training_data_fraction = 0.01430, run_name = reddit_s2s-256k-noelmo, elmo_chars_only = 1, lr = 0.001, max_grad_norm = 1.0, mt_attention = bilinear, max_seq_len = 64, batch_size = 24" JIANT_CONF="config/final.conf" sbatch nyu_cilvr_cluster.sbatch
